...
### Steps
1. Wire `cmd/yaama/main.go` to launch a Bubble Tea program.
...
2. Add empty-state UI copy with first-run hints (`n`, `yaama status ...`).
...
- Running `yaama` opens a stable TUI shell with placeholder columns.
